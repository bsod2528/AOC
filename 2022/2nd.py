...
print(f"{the_arrow}{white} Therefore, we will be getting a total of {red}{total_score}{white} considering the fact we are {blue}assuming{white} the strategy.{escape}[0m")
...
print(f"{the_arrow}{white} Therefore, we will be getting a total of {red}{total_score}{white} considering the fact we are going as {blue}per the accurate{white} strategy.{escape}[0m")
